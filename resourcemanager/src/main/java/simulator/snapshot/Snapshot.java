...
public class Snapshot {
    ...
    private static ConcurrentHashMap<PeerDescriptor, PeerInfo> peers = new ConcurrentHashMap<PeerDescriptor, PeerInfo>();
    private static int counter = 0;
    private static String FILENAME = "search.out";

    public static Map<Long, Long> restoreTimeMap = new HashMap<Long, Long>();
